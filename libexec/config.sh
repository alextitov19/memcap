...
MC_CONFIG_KEYS="BUDGET_MODE TOTAL_BUDGET_GB DOCKER_BUDGET_GB DOCKER_CPUS SOFT_TRIGGER \
...
QUEUE_POLICY QUEUE_MAX_JOBS QUEUE_WORKERS QUEUE_JOB_GB QUEUE_HEADROOM_GB QUEUE_POLL_SEC QUEUE_WAIT_SEC QUEUE_MAX_PRESSURE \
GC_MODE GC_IDLE_SEC"
